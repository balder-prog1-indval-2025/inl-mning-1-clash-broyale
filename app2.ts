...
let GnomeHitbox = new Hitbox(1015,350,25,50)
...
death_zone.push(new Hitbox(1015, 395, 30, 60))
...
ctx.drawImage(SpikeLeft, 1010, 405, 20, 20)
ctx.drawImage(SpikeLeft, 1010, 390, 20, 20)
...
ctx.drawImage(SpikeRight, 1030, 405, 20, 20)
ctx.drawImage(SpikeRight, 1030, 390, 20, 20)
...
ctx.drawImage(Gnome, 1015,350,25,50)
    }
}
