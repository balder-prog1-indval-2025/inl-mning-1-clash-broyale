...
death_zone.push(new Hitbox(50, 116, 30, 210))
...
death_zone.push(new Hitbox(192, 298, 1, 3)) 
...
// SpikeDownHitbox
death_zone.push(new Hitbox(369, 445, 15, 33)) 
...
let WallHitbox = []
  let DirtAndStoneHitboxes = [
    ...
    WallHitbox.push(new Hitbox(150, 215, 25, 25)),
    WallHitbox.push(new Hitbox(175, 200, 25, 25)),
    WallHitbox.push(new Hitbox(175, 215, 25, 25)),
    
    WallHitbox.push(new Hitbox(200, 200, 25, 25)),
    WallHitbox.push(new Hitbox(200, 215, 25, 25)),
    WallHitbox.push(new Hitbox(225, 175, 25, 25)),
    WallHitbox.push(new Hitbox(225, 200, 25, 25)),
    WallHitbox.push(new Hitbox(225, 215, 25, 25)),
